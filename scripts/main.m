...
my_options = {"Metodo de trapecios", "Simpson", "Punto Medio", "Quadratura gaussiana","Ver ayuda"};
[sel, ok] = listdlg ("ListString", my_options, "SelectionMode", "Multiple");

      datos=strcat("Valor aproximado por Fortran de QUADPACK: ",num2str(quadcc(fx,a,b,0.00000000000001),"%5.14f"),"\n","Metodo_______________\t Cota de error     -      Resultado    -     Tiempo");  
